-- ============================================================================
-- NEGOTIA — Seed Data (run after schema + schema_v2)
-- ============================================================================

-- Client
insert into users (id, email, name, role, auth_provider, password_hash, avatar_url, skills, portfolio_links, past_work,
...
-- Freelancer 1
insert into users (id, email, name, role, auth_provider, password_hash, avatar_url, skills, capabilities, experience, portfolio_links, past_work,
  total_earnings_cents, completed_jobs, active_jobs, rating, review_count, profile_completed, created_at)
values (
...
values
  ('a1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
   ...
   'OPEN',
   now() - interval '1 hour'),
  ('a2a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
   'c1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
  ...
  ('a3a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
   'c1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
   'Migrate jQuery frontend to React',
   'Legacy admin panel with 15+ pages using jQuery. Need migration to React with TypeScript. Complex data tables, charts, and real-time updates.',
   450000,
   'Payment on delivery. Must maintain all existing functionality. Tests required before handover.',
   'OPEN',
   now() - interval '3 hours'),
  ('a4a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
   'c1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
  ...
  ('a5a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
   'c1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
...
values (
  'a6a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
  'c1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
  'f1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
...
insert into projects (id, job_id, title, description, budget_cents, agreement_text, status, progress, client_id, freelancer_id)
values (
  'd1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
  'a6a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
  'Set up CI/CD pipeline with GitHub Actions',
