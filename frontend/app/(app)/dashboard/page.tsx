...
import { DollarIcon, BriefcaseIcon, StarIcon, WalletIcon } from '@/components/icons';
  ...
  return (
    <div className="page-container">
      <div className="mb-4">
        ...
        <p className="text-xs text-txt-secondary">Your financial overview</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        {statCards.map((card) => (
          <div key={card.label} className="stat-card">
            ...
            {card.showPayout && (stats?.pendingPaymentsCents ?? 0) > 0 && (
              <button
      ...
      {projects.length > 0 && (
        <div>
          <h2 className="section-title mb-3 text-sm">Ongoing Projects</h2>
